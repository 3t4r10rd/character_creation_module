...
class Character:
    ...
    def special(self):
        return (f'{self.name} применил специальное умение '
                f'равный "{self.SPECIAL_SKILL} {self.SPECIAL_BUFF}".')
...
def choice_char_class(char_name: str) -> Character:
    ...
    while approve_choice != 'y':
        selected_type = input('Введи название персонажа, '
                              'за которого хочешь играть: Воитель — warrior, '
                              'Маг — mage, Лекарь — healer: ')
        char_class = game_classes[selected_type](char_name)
        print(char_class)
...
def start_training(char_class: Character) -> str:
    '''Обрабатывает тренировку персонажа.
    '''
    commands = {
